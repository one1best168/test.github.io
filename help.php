...
<head>
<meta charset="utf-8"/>
<title>白云易支付平台 - 一站式免签约支付</title>
<meta name="keywords" content="白云易支付平台,支付宝免签约即时到账,财付通免签约,微信免签约支付,QQ钱包免签约,免签约支付,"/>
<meta name="description" content="白云易支付平台可以助你一站式解决网站签约各种支付接口的难题，现拥有支付宝、财付通、QQ钱包、微信支付等免签约支付功能，并有开发文档与SDK，可快速集成到你的网站"/>
<meta name="viewport"content="user-scalable=no, width=device-width">
<meta name="viewport"content="width=device-width, initial-scale=1"/>
<meta name="renderer"content="webkit">
<link rel="stylesheet"href="https://dn-template.qbox.me/ui/angulr_2.0.1/bower_components/font-awesome/css/font-awesome.min.css"type="text/css"/>
<link rel="stylesheet"href="https://dn-template.qbox.me/ui/angulr_2.0.1/bower_components/bootstrap/dist/css/bootstrap.css"type="text/css"/>
<link rel="stylesheet"href="https://dn-template.qbox.me/template/spay/common.css">
<link rel="stylesheet"href="https://dn-template.qbox.me/template/spay/index-top.css">
<!--[if IE 9 ]><style type="text/css">#ie9{ display:block; }</style><![endif]-->
<script src="https://dn-template.qbox.me/ui/angulr_2.0.1/bower_components/jquery/dist/jquery.min.js"></script>
<script src="https://dn-template.qbox.me/ui/angulr_2.0.1/bower_components/bootstrap/dist/js/bootstrap.js"></script>
<script src="https://dn-template.qbox.me/template/spay/jquery-ujs.js"async="true"></script>
<link rel="stylesheet"type="text/css"href="https://dn-template.qbox.me/template/spay/index.css"/>
...
<![endif]--><link rel="stylesheet"href="https://dn-template.qbox.me/template/spay/common1.css"/>
...
<li><a href="/">首页</a></li>
<li><a href="/user/login.php">商户中心</a></li>
<li><a href="http://wpa.qq.com/msgrd?v=3&uin=2909356786&site=qq&menu=yes">申请接入</a></li>
<li><a href="https://jq.qq.com/?_wv=1027&k=5Leqkwe">加入QQ群</a></li>
...
<p>本文阅读对象：商户系统（在线购物平台、人工收银系统、自动化智能收银系统或其他）集成微网络支付涉及的技术架构师，研发工程师，测试工程师，系统运维工程师。</p>
<h2 id="toc1">接口申请方式</h2>
<p>共有两种接口模式：</p>
<p>（一）普通支付商户<br/>可以获得一个支付商户，完全免费申请。公测期间请联系人工申请QQ<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=2909356786&amp;site=qq&amp;menu=yes">2909356786</a>，申请之后会将商户ID和商户KEY给你！</p>
<p>（二）合作支付商户<br/>获得一个合作者身份TOKEN，可以集成到你开发的程序里面，通过接口无限申请普通支付商户，并且每个普通支付商户单独结算，相对独立。公测期间请联系人工申请QQ<a target="_blank" href="http://wpa.qq.com/msgrd?v=3&amp;uin=2909356786&amp;site=qq&amp;menu=yes">2909356786</a>，申请之后会将合作者身份TOKEN给你！</p>
<h2 id="toc2">协议规则</h2>
<p>传输方式：HTTP</p>
<p>数据格式：JSON</p>
<p>签名算法：MD5</p>
...
<p>URL地址：http://pay.cwwcn.top/api.php?act=apply&amp;token={合作者身份TOKEN}&amp;url={商户域名}</p>
<p>请求参数说明：</p>
...
<p>URL地址：http://pay.cwwcn.top/api.php?act=query&amp;pid={商户ID}&amp;key={商户密钥}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<table class="table table-bordered table-hover">
  ...
  <tr><td>结算账号</td><td>account</td><td>String</td><td>13434878475@163.com</td><td>结算的支付宝账号</td></tr>
  <tr><td>结算姓名</td><td>username</td><td>String</td><td>白云</td><td>结算的支付宝姓名</td></tr>
...
<p>URL地址：http://pay.cwwcn.top/api.php?act=change&amp;pid={商户ID}&amp;key={商户密钥}&amp;account={结算账号}&amp;username={结算姓名}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
  ...
  <tr><td>商户ID</td><td>pid</td><td>是</td><td>Int</td><td>1001</td><td></td></tr>
  <tr><td>商户密钥</td><td>key</td><td>是</td><td>String</td><td>89unJUB8HZ54Hj7x4nUj56HN4nUzUJ8i</td><td></td></tr>
  <tr><td>结算账号</td><td>account</td><td>是</td><td>String</td><td>13434878475@163.com</td><td>结算的支付宝账号</td></tr>
  <tr><td>结算姓名</td><td>username</td><td>是</td><td>String</td><td>白云</td><td>结算的支付宝姓名</td></tr>
  </tbody>
</table>
<p>返回结果：</p>
<table class="table table-bordered table-hover">
...
<p>URL地址：http://pay.cwwcn.top/api.php?act=settle&amp;pid={商户ID}&amp;key={商户密钥}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<p>URL地址：http://pay.cwwcn.top/api.php?act=order&amp;pid={商户ID}&amp;key={商户密钥}&amp;out_trade_no={商户订单号}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<table class="table table-bordered table-hover">
  ...
  <tr><td>易支付订单号</td><td>trade_no</td><td>String</td><td>2016080622555342651</td><td>微网络支付订单号</td></tr>
...
<p>URL地址：http://pay.cwwcn.top/api.php?act=orders&amp;pid={商户ID}&amp;key={商户密钥}</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<p>URL地址：http://pay.cwwcn.top/submit.php?pid={商户ID}&amp;type={支付方式}&amp;out_trade_no={商户订单号}&amp;notify_url={服务器异步通知地址}&amp;return_url={页面跳转通知地址}&amp;name={商品名称}&amp;money={金额}&amp;sitename={网站名称}&amp;sign={签名字符串}&amp;sign_type=MD5</p>
<p>请求参数说明：</p>
<table class="table table-bordered table-hover">
  <thead><tr><th>字段名</th><th>变量名</th><th>必填</th><th>类型</th><th>示例值</th><th>描述</th></tr></thead>
  <tbody>
...
<table class="table table-bordered table-hover">
  ...
  <tbody>
  <tr><td>商户ID</td><td>pid</td><td>是</td><td>Int</td><td>1001</td><td></td></tr>
  <tr><td>易支付订单号</td><td>trade_no</td><td>是</td><td>String</td><td>20160806151343349021</td><td>微网络支付订单号</td></tr>
...
<h2 id="sdk0">SDK下载</h2>
<blockquote>
<a href="./W_Sdk.zip" style="color:blue">W_Sdk.zip</a><br/>
SDK版本：V1.0
</blockquote>
...
<ul class="porduct">
<h4>合作伙伴</h4>
<li><a href="http://pay.cwwcn.top/" target="_blank">白云易支付/白云易支付</a></li>
</ul>
<ul class="price">
<h4>关于我们</h4>
<li>微网络支付平台是福州市微网络科技旗下的免签约支付产品</li>
</ul>
<ul class="about"style="width: 40%;padding-left: 22px;">
<h4>联系我们</h4>
<li><strong>QQ:</strong><a target="_blank"href="http://wpa.qq.com/msgrd?v=3&amp;uin=2909356786&amp;site=qq&amp;menu=yes">2909356786</a></li>
<li><strong>Email:</strong><a name="baidusnap4"></a><a href="mailto:2909356786@soku.cc">2909356786@soku.cc</a></li>
</ul>
</div>

</div>
<div class="xinxi">
<p>Copyright © 2017 白云易支付  ©️  白云易支付 | Powered by <a href="http://pay.cwwcn.top/">pay.cwwcn.top</a></p>
</div>
<script type="text/javascript">
